...
/*   Updated: 2020/11/23 17:18:47 by olidon           ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
int		main(void)
{
	...
	SuperTrap	SuperTrap1("SuperTrap1");
	SuperTrap	SuperTrap2(SuperTrap("SuperTrap2"));
	SuperTrap	SuperTrapClone;

	SuperTrapClone = SuperTrap2;

	SuperTrap1.takeDamage(55);
	SuperTrap1.takeDamage(55);
	SuperTrap1.takeDamage(55);
	SuperTrap1.takeDamage(55);
	SuperTrap1.beRepaired(100);
	SuperTrap1.meleeAttack("Alpha Skag");
	SuperTrap1.rangedAttack("Badass Nomad");
	SuperTrap1.ninjaShoebox(SuperTrap1);
	SuperTrap1.vaulthunter_dot_exe("Badass Psycho");
	return 0;
}
